  ...
  return (
    <section className="w-full py-6 px-4 flex flex-col items-center gap-6">
      <header className="text-center">
        <h1 className="text-4xl font-[one] py-25">"Your AI everything app."</h1>
        <h2 className="text-[3.5vw] font-bold">One space for every team.</h2>
      </header>
      ...
      <ul className="flex flex-wrap justify-center gap-0.5">
        {team.map((tag) => (
          <li
            ...
            className={`py-1 px-4 bg-gray-200 rounded-full hover:bg-gray-100 transition-all duration-300 cursor-pointer ${
