...
export default function UpcomingEvents() {
  return (
    <div className="bg-[#1f1f1f] text-zinc-600 p-6 max-sm:p-0 rounded-xl flex mt-20 flex-col md:flex-row gap-4 w-full max-w-4xl mx-auto shadow-lg">
      {/* Left Panel */}
      <div className="flex-1 p-6 rounded-lg flex flex-col justify-between">
        <div className="flex items-start flex-col gap-2">
          <i className="ri-calendar-todo-fill text-3xl"></i>
          <div>
            <h2 className="text-lg font-[Notion-Regular] font-semibold leading-6 max-sm:text-sm">
      ...
      {/* Right Panel */}
      <div className="flex-1 p-6 rounded-lg max-sm:p-2">
